  ...
  methods: {
    ...
    '- dispatchTouch:': {
      ...
      implementation: function (sender) {
        ...
        // FIXME: this only works on 64 bit, need to fix Frida
        const timestamp = [
            parseInt(absoluteTime.shr(32).toString(16), 16),
            parseInt(absoluteTime.and(0xffffffff).toString(16), 16)
        ];
        ...
        /*
         * FIXME: Frida ObjC bug prevents this call:
         *
